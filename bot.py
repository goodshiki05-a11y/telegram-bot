...
VIP_LINK_3 = "https://t.me/+Uf6RWm1E4e1mMTY6"  

async def join(update: Update, context: ContextTypes.DEFAULT_TYPE):
    req = update.chat_join_request

    text = """𝗦𝗶𝘇𝗻𝗶𝗻𝗴 𝗧𝗥𝗔𝗗𝗜𝗡𝗚 Kanalimizga 𝗾𝗼'𝘀𝗵𝗶𝗹𝗶𝘀𝗵 𝘀𝗼'𝗿𝗼𝘃𝗶𝗻𝗴𝗶𝘇 𝗺𝘂𝘃𝗮𝗳𝗳𝗮𝗾𝗶𝘆𝗮𝘁𝗹𝗶 𝘁𝗮𝘀𝗱𝗶𝗾𝗹𝗮𝗻𝗱𝗶 ✅
...
🎁 𝗦𝗶𝘇𝗴𝗮 𝗯𝗼𝗻𝘂𝘀 𝘀𝗶𝗳𝗮𝘁𝗶𝗱𝗮 𝗯𝗶𝘇𝗻𝗶𝗻𝗴 𝗩𝗜𝗣 𝘃𝗮 𝗥𝗔𝗭𝗚𝗢𝗡 𝗞𝗔𝗡𝗔𝗟𝗟𝗔𝗥𝗜𝗠𝗜𝗭 𝗾𝗼‘𝘀𝗵𝗶𝗯 𝗯𝗲𝗿𝗶𝗹𝗱𝗶❗️"""
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("VIP KANAL 3", url=VIP_LINK_3)]  
    ]
